...
/* -------------------------------------------------
   Directions
   Must match player->direction values
   ------------------------------------------------- */
#define DIR_DOWN  0
#define DIR_LEFT  1
#define DIR_RIGHT 2
...
bool IsInteractionReachableFromAnySide(
    const TileMap *map,
...
bool IsInteractionReachableFromFrontOnly(
    const TileMap *map,
    Vector2 playerWorldPos,
    int playerDirection,
    int targetTileX,
...
int GetReachableInteractionAnySide(
    const TileMap *map,
    Vector2 playerWorldPos,
