...
SRC_DIRS = Game Game/Character_System Game/MapLoader Game/cJSON Game/game Game/platformUtils Game/Inventory Game/Interactions/Bronze_Altar Game/Interactions/Incense_Altar Game/Interactions/Wood_Stack Game/Interactions/Storage Game/Interactions/Menorah Game/Interactions/Laver
#include "../../game/game.h"
#include <stdio.h>
